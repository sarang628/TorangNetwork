...
interface ApiReview {
    ...
    @POST("addMenuReview")
    suspend fun addMenuReview(@Body menuReview: MenuReviewApiModel): Call<MenuReviewApiModel>

    @POST("getMyMenuReviews")
    suspend fun getMyMenuReviews(@Body review: FeedApiModel): Call<ArrayList<MenuReviewApiModel>>
