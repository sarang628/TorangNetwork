...
interface ApiFeedV1 {
    ...
    @GET("user/{userId}/restaurant/{restaurantId}")     suspend fun findByUserAndRestaurantId   (@Header("authorization") auth: String?, @Path("userId") userId: Int, @Path("restaurantId") restaurantId: Int) : List<FeedApiModel>
